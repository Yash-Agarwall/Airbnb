...
export default function EditListing() {
  ...
  const validateForm = () => {
    ...
    if (!listing.description?.trim())
      newErrors.description = "Add some short description";
    ...
    if (!listing.category?.trim()) newErrors.category = "Select a category";
  ...
  const getInputClasses = (fieldName) => {
    const baseClasses =
      "border p-4 rounded outline-none transition-all duration-300";
